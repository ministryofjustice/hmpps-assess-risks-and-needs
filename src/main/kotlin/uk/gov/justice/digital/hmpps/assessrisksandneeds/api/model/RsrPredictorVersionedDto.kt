...
data class RsrPredictorVersionedDto(
  ...
  companion object {
    ...
    fun from(oasysPredictorsDtos: List<RiskPredictorAssessmentDto>): List<RsrPredictorVersionedDto> =
      oasysPredictorsDtos.map { from(it) }

    fun from(oasysPredictorsDto: RiskPredictorAssessmentDto): RsrPredictorVersionedDto {
      return RsrPredictorVersionedDto(
        calculatedDate = null,
