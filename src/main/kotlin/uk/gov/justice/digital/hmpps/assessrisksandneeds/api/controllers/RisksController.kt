...
class RisksController(
  ...
  @PreAuthorize("hasAnyRole('ROLE_PROBATION', 'ROLE_CRS_PROVIDER', 'ROLE_ACCREDITED_PROGRAMS_RO', 'ROLE_OFFENDER_CATEGORISATION_RO', 'ROLE_ARNS__RISKS__RO', 'ROLE_ESUPERVISION_API_RISKS_RO')")
